...
// ---------- Pins ----------
#define POT_SERVO_PIN 34   // ADC (input-only OK)
#define POT_MOTOR_PIN 35   // ADC
#define BTN_LED1_PIN  32   // knap til LED bit0 (aktiv lav)
#define BTN_LED2_PIN  33   // knap til LED bit1
#define BTN_LED3_PIN  25   // knap til LED bit2
